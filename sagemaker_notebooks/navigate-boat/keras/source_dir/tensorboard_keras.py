...
def keras_model_fn(learning_rate):
    
    model = Sequential()
    model.add(Dense(128, input_shape=(HEIGHT, WIDTH, DEPTH), activation='relu', kernel_initializer='normal'))
    #model.add(Dense(128, input_dim=INPUT_DIM, activation='relu', kernel_initializer='normal'))
...
def main(args):
    ...
    model = keras_model_fn(args.learning_rate)
